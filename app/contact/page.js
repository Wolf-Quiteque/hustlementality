...
export default async function ContactPage() {
  ...
  const bannerImage = text(c, "contact_banner_image", "/images/turnups/07.jpeg");
  const phone = text(c, "contact_phone", "+1 (305) 555-1234");
  const email = text(c, "contact_email", "info@hustlementality.com");
  const location = text(c, "contact_location", "Miami, Florida");
  const hours = text(c, "contact_hours", "Mon - Fri: 9:00 AM - 6:00 PM EST");
  const social = parseJson(c, "contact_social_links", { twitter: "#", facebook: "#", tiktok: "#", instagram: "#" });
  ...
  return (
    <>
      ...
      <section className="hm-page-banner bg-cover" style={{ backgroundImage: `url('${bannerImage}')` }}>
        <div className="container">
          ...
          <div className="hm-breadcrumb wow fadeInUp" data-wow-delay=".2s">
            <a href="/">Home</a><span className="separator">/</span><span>Contact</span>
          </div>
          <p className="subtitle wow fadeInUp" data-wow-delay=".3s">Have a question or ready to book? We&apos;d love to hear from you.</p>
        </div>
      </section>
          ...
          <div className="row g-4">
            ...
            <div className="col-lg-7 wow fadeInUp">
              <div className="sec-title mb-4">
                <div className="sec-sub-title"><h6 className="sub-title tz-sub-tilte tz-sub-anim tx-subTitle">Get In Touch</h6></div>
                <h2 className="title tx-title sec_title tz-itm-title tz-itm-anim">Send Us a Message</h2>
              </div>
            ...
            <div className="col-lg-5 wow fadeInUp" data-wow-delay=".3s">
              <div className="hm-contact-info-card">
                ...
                <p style={{ color: "rgba(255,255,255,0.7)", marginBottom: "30px", lineHeight: 1.7 }}>
                  Reach out to us directly or fill out the form. Our team responds within 24 hours.
                </p>
                <div className="hm-contact-info-item">
                  <div className="icon"><i className="fa-solid fa-phone"></i></div>
                  <div className="info"><h5>Phone</h5><a href={`tel:${phone.replace(/[^+\d]/g, "")}`}>{phone}</a></div>
                </div>
                <div className="hm-contact-info-item">
                  <div className="icon"><i className="fa-solid fa-envelope"></i></div>
                  <div className="info"><h5>Email</h5><a href={`mailto:${email}`}>{email}</a></div>
                </div>
                <div className="hm-contact-info-item">
                  <div className="icon"><i className="fa-solid fa-location-dot"></i></div>
                  <div className="info"><h5>Location</h5><p>{location}</p></div>
                </div>
                <div className="hm-contact-info-item">
                  <div className="icon"><i className="fa-solid fa-clock"></i></div>
                  <div className="info"><h5>Office Hours</h5><p>{hours}</p></div>
                </div>
                <div className="hm-contact-social">
                  <a href={social.twitter || "#"} aria-label="Twitter"><i className="fa-brands fa-x-twitter"></i></a>
                  <a href={social.facebook || "#"} aria-label="Facebook"><i className="fab fa-facebook-f"></i></a>
                  <a href={social.tiktok || "#"} aria-label="TikTok"><i className="fab fa-tiktok"></i></a>
                  <a href={social.instagram || "#"} aria-label="Instagram"><i className="fab fa-instagram"></i></a>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="row g-4 justify-content-center mb-50">
            <div className="col-lg-8 text-center">
              <div className="sec-title mb-0">
                <div className="sec-sub-title bg-white"><h6 className="sub-title tz-sub-tilte tz-sub-anim tx-subTitle">Ready to Book?</h6></div>
                <h2 className="title tx-title sec_title tz-itm-title tz-itm-anim">How to Reserve Your Spot</h2>
              </div>
            </div>
          </div>
          <div className="row g-4">
            <div className="col-lg-4 wow fadeInUp" data-wow-delay=".2s">
              <div className="dst-step-card">
                ...
                <div className="dst-step-icon"><i className="fa-solid fa-comment-dots fa-3x"></i></div>
                <h4 className="dst-step-title">Reach Out</h4>
                <p className="dst-step-text">Send us a message with your preferred package and any questions. We&apos;ll respond within 24 hours.</p>
              </div>
            </div>
      ...
      <section className="fix">
        <div style={{ width: "100%", height: "400px", background: "var(--theme-color2)", display: "flex", alignItems: "center", justifyContent: "center", flexDirection: "column", gap: "15px" }}>
          <i className="fa-solid fa-map-location-dot fa-4x" style={{ color: "var(--theme-color1)" }}></i>
          <h4 style={{ color: "#fff", fontSize: "24px" }}>{location}</h4>
          <p style={{ color: "rgba(255,255,255,0.6)", fontSize: "16px" }}>Home port for The Bahamas Wave</p>
        </div>
      </section>
    </>
  );
